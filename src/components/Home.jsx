    ...
    <div className="min-h-screen bg-[#f8f9fa] pb-20 md:pb-0">
      ...
      <section className="relative h-[400px] sm:h-[500px] overflow-hidden">
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center text-center px-6">
          ...
          <button onClick={() => handleAction("/cases?status=Adoption%20Pending")} className="px-8 py-4 bg-[#34c759] hover:bg-[#28a745] text-white font-bold text-lg rounded-full transition shadow-lg transform hover:scale-105">FIND YOUR PAWTNER</button>
        </div>
